                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <a href="{{ route('allergieen_detail', ['gezin_id' => $gezin->GezinId]) }}" class="text-blue-500 border border-blue-200 bg-blue-50 hover:bg-blue-100 rounded px-2 py-1 inline-flex items-center justify-center transition">
