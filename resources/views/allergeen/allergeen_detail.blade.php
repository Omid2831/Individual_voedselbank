                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <a href="{{ route('allergieen_edit', ['id' => $persoon->PersoonId]) }}" class="bg-blue-500 hover:bg-blue-600 text-white rounded px-2 py-1 inline-flex items-center justify-center transition shadow-sm">
